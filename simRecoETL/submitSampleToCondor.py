...
os.system("tar -cvzf {0} ./ --exclude 'dpg*' --exclude '.git' --exclude 'test*' --exclude 'submitOneFile_' --exclude '*.tar.gz' --exclude 'minBias*' --exclude 'single*' --exclude '*-19' --exclude '*2019'  --exclude 'quick*' --exclude 'oldFilelists' --exclude 'fileLists*'".format(tarball_name))
